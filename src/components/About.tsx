    ...
    <section id="about" className="py-20 relative overflow-hidden">
      <div className="container mx-auto px-4 relative">
                ...
                {[
                  ...
                  >
                    <div className="mb-2 sm:mb-3 group-hover:scale-110 transition-transform duration-300">
                      <IconComponent className="w-6 h-6 sm:w-8 sm:h-8 mx-auto text-primary" />
                    </div>
        ...
        <motion.div
          ...
          className="px-4"
        >
          <h3 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">My Journey</h3>
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 w-1 h-full bg-gradient-primary rounded-full"></div>
            ...
            {timeline.map((item, index) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 w-6 sm:w-8 h-6 sm:h-8 bg-gradient-primary rounded-full border-3 sm:border-4 border-background z-10 flex items-center justify-center">
