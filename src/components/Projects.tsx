...
import { ExternalLink, Github, Star, Calendar, Code2, Loader2, AlertCircle } from 'lucide-react';
...
const Projects = ({
  ...
  // Don't render the section at all if featured variant has no data and finished loading
  ...
  return (
    <section id={sectionId} className="py-14 sm:py-16 lg:py-20 relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        {!loading && !error && displayProjects.length === 0 && (
          <div className="text-center py-12">
            <Code2 className="h-10 w-10 mx-auto text-muted-foreground/30 mb-3" />
            <p className="text-muted-foreground">{isFeaturedVariant ? 'No featured projects added yet.' : 'No projects found in this category.'}</p>
          </div>
        )}
